        ...
        this.panel.webview.onDidReceiveMessage((msg) => __awaiter(this, void 0, void 0, function* () {
            ...
            switch (msg.command) {
                ...
                case 'commitDetails':
                    ...
                    break;
                case 'compareCommits':
                    this.sendMessage(Object.assign({ command: 'compareCommits', commitHash: msg.commitHash, compareWithHash: msg.compareWithHash }, yield this.dataSource.compareCommits(msg.repo, msg.fromHash, msg.toHash), { refresh: msg.refresh }));
                    break;
                ...
                case 'createBranch':
                    this.sendMessage({
                        ...
                        error: yield this.dataSource.createBranch(msg.repo, msg.branchName, msg.commitHash)
                    });
                    break;
                case 'deleteBranch':
                    this.sendMessage({
                ...
                case 'deleteTag':
                    this.sendMessage({
                        command: 'deleteTag',
                        error: yield this.dataSource.deleteTag(msg.repo, msg.tagName)
                    });
                    break;
                case 'fetch':
                    this.sendMessage({
                        command: 'fetch',
                        error: yield this.dataSource.fetch(msg.repo)
                    });
                    break;
                case 'fetchAvatar':
                ...
                case 'mergeBranch':
                    this.sendMessage({
                        command: 'mergeBranch',
                        error: yield this.dataSource.mergeBranch(msg.repo, msg.branchName, msg.createNewCommit, msg.squash)
                    });
                    break;
                case 'mergeCommit':
                    this.sendMessage({
                        command: 'mergeCommit',
                        error: yield this.dataSource.mergeCommit(msg.repo, msg.commitHash, msg.createNewCommit, msg.squash)
                    });
                    break;
                case 'pushBranch':
                    this.sendMessage({
                        command: 'pushBranch',
                        error: yield this.dataSource.pushBranch(msg.repo, msg.branchName, msg.remote, msg.setUpstream)
                    });
                    break;
                case 'pushTag':
                    this.sendMessage({
                ...
                case 'rebaseOn':
                    this.sendMessage({
                        ...
                        error: yield this.dataSource.rebaseOn(msg.repo, msg.base, msg.type, msg.ignoreDate, msg.interactive)
                    });
                    break;
                case 'renameBranch':
                    this.sendMessage({
