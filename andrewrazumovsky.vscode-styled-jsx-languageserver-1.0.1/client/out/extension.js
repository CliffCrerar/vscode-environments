...
function activate(context) {
    ...
    var serverModule = context.asAbsolutePath(path.join('server', 'out', 'styled-jsx-server-main.js'));
    ...
    var documentSelector = ['javascriptreact', 'javascript', 'typescriptreact', 'typescript'];
    ...
    var client = new vscode_languageclient_1.LanguageClient('styled.jsx', 'styled-jsx Language Server', serverOptions, clientOptions);
    ...
    client.onReady().then(function (_) {
        client.code2ProtocolConverter.asPosition(vscode_1.window.activeTextEditor.selection.active);
    ...
    vscode_1.commands.registerCommand('styled.jsx.applyCodeAction', applyCodeAction);
