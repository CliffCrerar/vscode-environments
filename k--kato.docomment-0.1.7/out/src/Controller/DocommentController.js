...
class DocommentController {
    ...
    loadConfig() {
        ...
        this._config.syntax = Configuration_1.CommentSyntax[confDocomment.get(Configuration_1.Configuration.SYNTAX, Configuration_1.CommentSyntax.single)];
        this._config.activateOnEnter = confDocomment.get(Configuration_1.Configuration.ACTIVATE_ON_ENTER, false);
        this._config.advanced = confDocomment.get(Configuration_1.Configuration.ADVANCED);
