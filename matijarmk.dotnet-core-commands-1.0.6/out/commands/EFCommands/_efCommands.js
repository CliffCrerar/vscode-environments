...
const dbcontextscaffold_1 = require("./dbcontextscaffold");
function efCommands() {
    ...
    vscode.window.showQuickPick(items, options).then(data => {
        switch (data.label) {
            ...
            case "Dbcontext scaffold": {
                dbcontextscaffold_1.dbcontextScaffold();
                break;
            }
        }
    });
}
exports.efCommands = efCommands;
//# sourceMappingURL=_efCommands.js.map