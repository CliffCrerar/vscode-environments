...
const codeMod = (fileInfo, api, options) => {
    ...
    else if (j.BooleanLiteral.check(path.node.consequent) &&
...
codeMod.canRun = (fileInfo, api, options) => {
    ...
    // foo ? true : false
    const booleanBranches = j.BooleanLiteral.check(node.consequent) && j.BooleanLiteral.check(node.alternate);
    // a ? a : b
...
//# sourceMappingURL=simplify-ternary.js.map