...
// export default class GitDroppedStashTreeDataProvider implements TreeDataProvider<StashNode> {
...
//             case NodeType.IndexAdded: return this.getIcon(scheme, 'indexed-untracked.png');
...
//         return !this.model ? this.model = new Model(this.config) : this.model;
//     }
// }
//# sourceMappingURL=GitDroppedStashTreeDataProvider.js.map