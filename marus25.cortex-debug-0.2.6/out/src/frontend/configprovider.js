...
const fs = require("fs");
const os = require("os");
class DeprecatedDebugConfigurationProvider {
...
exports.DeprecatedDebugConfigurationProvider = DeprecatedDebugConfigurationProvider;
const OPENOCD_VALID_RTOS = ['eCos', 'ThreadX', 'FreeRTOS', 'ChibiOS', 'embKernel', 'mqx', 'uCOS-III'];
