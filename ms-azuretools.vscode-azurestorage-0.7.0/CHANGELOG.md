...
### Added
- "Browse Static Website…" will bring up a storage account's primary web endpoint in a browser (see [Deploy to Static Website](https://github.com/Microsoft/vscode-azurestorage/blob/master/README.md#deploy-to-static-website))
...
### Added
- Deploy to static websites (preview feature, must be [enabled](https://github.com/Microsoft/vscode-azurestorage/blob/master/README.md#preview-features) first)
