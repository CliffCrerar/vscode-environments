...
![user story autocomplete](https://github.com/ipatalas/vscode-sprint-planner/raw/master/images/planner-1.gif)

If you wish to add tasks for iteration other than current you can do so by choosing it at the beginning of the file:

![iteration autocomplete](https://github.com/ipatalas/vscode-sprint-planner/raw/master/images/planner-2.gif)

Then it's time to enter some tasks in the following manner:

![user story autocomplete](https://github.com/ipatalas/vscode-sprint-planner/raw/master/images/planner-tasks.png)
