...
import { TextDocument, Position, CompletionList, FormattingOptions, Diagnostic, CompletionItem, TextEdit, Hover, SymbolInformation } from 'vscode-languageserver-types';
...
export declare function getLanguageService(schemaRequestService: SchemaRequestService, contributions: JSONWorkerContribution[], customSchemaProvider: CustomSchemaProvider, workspaceContext?: WorkspaceContextService, promiseConstructor?: PromiseConstructor): LanguageService;
