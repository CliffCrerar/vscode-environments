...
export declare class ASTNode {
    ...
    static getIgnoreValueCase(schema: JSONSchema): boolean;
    static getIgnoreKeyCase(schema: JSONSchema): boolean;
...
export declare class ValidationResult {
    problems: IProblem[];
    problemDepths: number[];
    firstPropertyProblems: number;
    ...
    constructor();
    hasProblems(): boolean;
    addProblem(problem: IProblem): void;
    mergeSubResult(validationResult: ValidationResult): void;
