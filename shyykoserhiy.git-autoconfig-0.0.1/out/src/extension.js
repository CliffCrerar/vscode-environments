    ...
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const setGitConfig = () => __awaiter(this, void 0, void 0, function* () {
            ...
            if (configList.length) {
                const map = configList.concat(config_1.CUSTOM_GIT_CONFIG).reduce((map, c) => {
                    map.set(config_1.generateGitConfigKey(c), c);
                    return map;
                }, new Map());
                const pick = yield vscode.window.showQuickPick(Array.from(map.keys()), { ignoreFocusOut: true, placeHolder: 'Select one of previous configs or new custom one.' });
        ...
        //commands
        const getConfigCommand = vscode.commands.registerCommand('git-autoconfig.getConfig', () => __awaiter(this, void 0, void 0, function* () {
            const repositoryRoot = yield findRepositoryRoot();
            if (!repositoryRoot) {
                return;
            }
        ...
        const setConfigCommand = vscode.commands.registerCommand('git-autoconfig.setConfig', () => __awaiter(this, void 0, void 0, function* () {
            yield setGitConfig();
        }));
