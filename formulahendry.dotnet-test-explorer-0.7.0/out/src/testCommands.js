        ...
        const runSeqOrAsync = () => __awaiter(this, void 0, void 0, function* () {
            ...
            try {
                if (utility_1.Utility.runInParallel) {
                    yield Promise.all(testDirectories.map((dir) => __awaiter(this, void 0, void 0, function* () { return discoveredTests.push(yield this.discoverTestsInFolder(dir)); })));
                }
                else {
                    for (const dir of testDirectories) {
                        discoveredTests.push(yield this.discoverTestsInFolder(dir));
                    }
                }
